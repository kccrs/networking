    ...
    if (this.state.editable === false) {
      ...
      return (
        <article className="Contact">
          ...
          <p className="blockInlineBlock"><span className="blockInlineBlock">Secondary Email: </span> {this.props.secondaryEmail}</p>
          <ul className="SocialMedia">
            <li className="blockInlineBlock"><span className="blockInlineBlock">Website: </span> {this.props.website}</li>
