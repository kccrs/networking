      ...
      return (
        <article className="Contact">
          ...
          <p className="blockInlineBlock">
            <span className="blockInlineBlock">Primary Phone: </span> {this.props.primaryPhone}</p>
          <p className="blockInlineBlock"><span className="blockInlineBlock">Secondary Phone: </span> {this.props.secondaryPhone}</p>
          <p className="blockInlineBlock"><span className="blockInlineBlock">Primary Email: </span> {this.props.primaryEmail}</p>
          <p className="blockInlineBlock"><span className="blockInlineBlock">Primary Email: </span> {this.props.secondaryEmail}</p>
          <ul className="SocialMedia">
            <li className="weblockInlineBlock"><span className="weblockInlineBlock">Website: </span> {this.props.website}</li>
          ...
          <p className="blockInlineBlock"><span className="blockInlineBlock">Category: </span> {this.props.category}</p>
          <p className="blockInlineBlock"><span className="blockInlineBlock">Notes: </span> {this.props.notes}</p>
          ...
          <div className="buttonContainer">
            ...
            <button className="EditButton" name="edit" onClick={() => this.setState({ editable: true })} >
              Edit
            </button>
