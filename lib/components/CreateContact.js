...
export default class CreateContact extends Component {
  ...
  createContact(e) {
    ...
    email, twitter, gitHub, website, linkedIn, category, notes, followUp} = this.state;
  ...
  render() {
    return (
      <form name="create-contact" className="CreateContact display" onSubmit={this.createContact.bind(this)}>
        ...
        <input {disabled} className="SaveButton" type="submit" name="submit" value="Save" />
      </form>
    );
  }
}

// var disabled = this.state.saveDisabled ? 'disabled' : ''
// return (
//   // stuff
